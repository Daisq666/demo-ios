...
extension ContentView_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        AnyView(__designTimeSelection(ContentView(), "#9000.[2].[0].property.[0].[0]"))
#sourceLocation()
    }
}
...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(Text(__designTimeString("#9000.[1].[0].property.[0].[0].arg[0].value.[0].value", fallback: "Hello, World!")), "#9000.[1].[0].property.[0].[0]"))
#sourceLocation()
    }
}
